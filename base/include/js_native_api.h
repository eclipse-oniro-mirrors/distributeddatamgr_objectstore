...
// Methods to control objectStore_ lifespan
...
// refcount is >0, and the referenced objectStore_ is effectively "pinned".
// Calling this when the refcount is 0 and the objectStore_ is unavailable
// results in an error.
...
// If the result is 0 the reference is now weak and the objectStore_ may be GC'd
